...
if __name__ == '__main__':
    data = pd.read_excel(r'Enterprise_News.xls')  #原文本文件
    data_result = Workbook(r'highlight.xlsx') #标注结果
    cate_data = pd.read_excel(r'keywords.xls') #匹配的文本文件
